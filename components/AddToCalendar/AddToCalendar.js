...
const AddToCalendar = () => {
  const [event, setEvent] = useState({
    ...
    description: 'Discuss background and upcoming hiring tasks.  email ▶️"yourEmail@live.com" ',
    /* you can import you image from a cdn like Linkedin or Github,  copy paste image url/link */
    image: '<img src="https://media.licdn.com/dms/image/D4D03AQEbs4OYFfJNIw/profile-displayphoto-shrink_400_400/0/1677634568239?e=1683763200&v=beta&t=udBxCDJKS54-tRjhmj3RmfMc0h4OZlnqO7iFW53JiPM" width="30" height="30">',
    location: 'Online',
  ...
  const constructOutlookUrl = () => {
    const outlookCalendarBaseUrl = 'https://outlook.office.com/calendar/0/deeplink/compose';
  ...
  const constructAppleUrl = () => {
    const appleCalendarBaseUrl = 'webcal://p25-calendars.icloud.com/published/2/abcdefghijklmno';
