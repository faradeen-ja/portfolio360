...
import dev1Image from '/public/images/fara.jpg'
import dev2Image from '/public/images/fara.jpg'
...
const FooterCard = () => {
  return (
    ...
    <div className="footer-elements-box "> {/* all elements >> flex flex col mobile */}
...
{/* fetching contributons from Github using gitup api components/GithubContributors*/}
    {/*   <div className="App">
      ...
      Collaboration is crucial because building complex software projects
       and products usually requires input and effort from multiple individuals with different  skill 
       sets, backgrounds, and perspectives. This diversity of thought and expertise leads to the
        development of better and more efficient systems.

      </p>
      <p className="text-gray-700 text-small text-center">
        This project is free to use and modify under the terms of the MIT license. Please credit the developers by adding a link to their profiles:
        ...
        <a href="https://github.com/chetanverma16" className="underline  ml-1">Chetan V</a>
        
        <a href="https://github.com/faradeen-ja" className="underline ml-1">FJ</a>
      </p>
      </div>
