...
const WorkCard = ({ img, name, description, onClick, tags }) => {
  ...
  return (
    ...
    <><div
      className="relative project-box overflow-hidden rounded-lg p-2 laptop:p-4 first:ml-0 link"
    ...
    >
      ...
      >
          ...
          <img
          onClick={onClick} /* moved onclick for project here for better accessibility and the  descreption card addition */
          alt={name}
