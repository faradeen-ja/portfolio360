...
<svg  className="svg1" fill="none" height="50px" viewBox="0 0 80 80" width="50px" xmlns="http://www.w3.org/2000/svg"><g fill="#000000"><path d="m14 44c-.803 0-1.557-.313-2.122-.88l-10.999-10.999c-.566-.564-.879-1.318-.879-2.121s.313-1.557.88-2.122l10.999-10.999c.564-.566 1.318-.879 2.121-.879 1.654 0 3 1.346 3 3 0 .803-.313 1.557-.88 2.122l-8.878 8.878 8.879 8.879c.567.564.879 1.318.879 2.121 0 1.654-1.346 3-3 3z"/><path d="m46 45c-1.654 0-3-1.346-3-3 0-.803.313-1.557.88-2.122l8.878-8.878-8.879-8.879c-.566-.566-.879-1.32-.879-2.121 0-1.654 1.346-3 3-3 .803 0 1.557.313 2.122.88l10.999 10.999c.567.566.879 1.32.879 2.121 0 .803-.313 1.557-.88 2.122l-10.999 10.999c-.564.567-1.318.879-2.121.879z"/><path d="m21 53c-1.654 0-3-1.346-3-3 0-.398.078-.787.23-1.155l18.001-40.002c.47-1.12 1.557-1.843 2.769-1.843 1.654 0 3 1.346 3 3 0 .398-.078.787-.23 1.155l-18.001 40.002c-.47 1.12-1.557 1.843-2.769 1.843z"/></g></svg>
  ...
  const stackSvg = (
    // eslint-disable-next-line react/no-unknown-property
    <svg fill="#000000" className="svg-center" width="50px" height="50px" viewBox="0 0 330 300" id="Flat" xmlns="http://www.w3.org/2000/svg">
    <g opacity="0.5">
...
const starSvg = (
  ...
  <svg id="Layer_1" height="50px" viewBox="0 0 125 120" width="50px" xmlns="http://www.w3.org/2000/svg"><path d="m90 38.558-10.091-17.477-19.909 11.497v-22.578h-20v22.571l-19.909-11.49-10.091 17.474 19.824 11.445-19.824 11.445 10.091 17.474 19.909-11.494v22.575h20v-22.578l19.912 11.497 10.088-17.477-19.817-11.442z"/></svg>
...
<svg id="Capa_1" enableBackground="new 0 0 511.936 511.936" height="50px" viewBox="0 0 690.936 700.936" width="50px" xmlns="http://www.w3.org/2000/svg"><g><path d="m288.185 106.21 64.434 64.435-43.221 43.221 53.105 53.106 96.327-96.327-170.645-170.645-170.645 170.645 53.106 53.105z"/><path d="m341.29 288.185-117.54 117.539-64.434-64.434 43.221-43.221-53.105-53.105-96.327 96.327 170.645 170.645 170.646-170.645z"/><path d="m218.417 202.854h75.102v106.226h-75.102z" transform="matrix(.707 -.707 .707 .707 -106.025 255.968)"/></g></svg>
)
...
<svg id="Capa_1" enableBackground="new 0 0 512 512" height="50px" viewBox="0 0 650 666" width="50px" xmlns="http://www.w3.org/2000/svg"><g><path d="m255.974 287.084c17.163 0 31.125-13.962 31.125-31.125s-13.962-31.125-31.125-31.125-31.125 13.962-31.125 31.125 13.963 31.125 31.125 31.125z"/><path d="m302.865 329.575-24.531-16.745c-6.931 2.735-14.469 4.254-22.36 4.254s-15.429-1.52-22.36-4.254l-24.53 16.746c-7.972 5.442-12.731 14.453-12.731 24.105v15.563c17.812 9.402 38.106 14.732 59.647 14.732 21.521 0 41.796-5.32 59.596-14.705v-15.59c0-9.653-4.76-18.664-12.731-24.106z"/><path d="m256 128.025c-70.679 0-127.975 57.296-127.975 127.975 0 35.931 14.814 68.397 38.66 91.641 1.765-17.244 10.996-32.953 25.484-42.844l15.944-10.884c-8.292-10.435-13.264-23.621-13.264-37.954 0-33.705 27.42-61.125 61.125-61.125s61.125 27.42 61.125 61.125c0 14.333-4.972 27.52-13.264 37.954l15.944 10.884c14.501 9.899 23.736 25.628 25.488 42.89 23.874-23.247 38.708-55.733 38.708-91.688 0-70.678-57.296-127.974-127.975-127.974z"/><path d="m241 57.427v48.102h30v-48.102l16.997 16.996 21.212-21.213-53.209-53.21-53.209 53.21 21.212 21.213z"/><path d="m271 454.573v-48.102h-30v48.102l-16.997-16.996-21.212 21.213 53.209 53.21 53.209-53.21-21.212-21.213z"/><path d="m82.751 192.921-6.221-23.218 41.658 24.052 15-25.981-41.658-24.051 23.218-6.222-7.765-28.977-72.686 19.476 19.477 72.686z"/><path d="m429.249 319.079 6.221 23.218-41.658-24.052-15 25.981 41.658 24.051-23.218 6.222 7.765 28.977 72.686-19.476-19.477-72.686z"/><path d="m118.188 318.245-41.658 24.052 6.221-23.218-28.977-7.765-19.477 72.686 72.686 19.476 7.765-28.977-23.218-6.222 41.658-24.051z"/><path d="m393.812 193.755 41.658-24.052-6.221 23.218 28.977 7.765 19.477-72.686-72.686-19.476-7.765 28.977 23.218 6.222-41.658 24.051z"/></g></svg>
)

const timeSvg = (

<svg xmlns="http://www.w3.org/2000/svg" id="glipy_copy_5" data-name="glipy copy 5" viewBox="0 0 80 79" width="50px" height="50px"><path d="M32,2A30,30,0,1,0,62,32,30.03661,30.03661,0,0,0,32,2ZM47.07,36.41l2.19,1.27a2.20774,2.20774,0,0,1,.8,3.02l-1.51,2.62a2.20794,2.20794,0,0,1-3.01.81l-2.2-1.27a15.74574,15.74574,0,0,1-7.63,4.4v2.53A2.21074,2.21074,0,0,1,33.5,52H30.48a2.21926,2.21926,0,0,1-2.22-2.21V47.26a15.64238,15.64238,0,0,1-7.61-4.42l-2.19,1.27a2.21784,2.21784,0,0,1-3.03-.81l-1.52-2.62a2.22937,2.22937,0,0,1,.82-3.02l2.19-1.27a15.77109,15.77109,0,0,1,.01-8.8l-2.19-1.27a2.20774,2.20774,0,0,1-.8-3.02l1.51-2.62a2.20794,2.20794,0,0,1,3.01-.81l2.2,1.27a15.74574,15.74574,0,0,1,7.63-4.4V14.21A2.21073,2.21073,0,0,1,30.5,12h3.02a2.21924,2.21924,0,0,1,2.22,2.21v2.53a15.64273,15.64273,0,0,1,7.61,4.42l2.19-1.27a2.21779,2.21779,0,0,1,3.03.81l1.52,2.62A2.19535,2.19535,0,0,1,50.3,25a2.139,2.139,0,0,1-1.03,1.34l-2.19,1.27A15.77088,15.77088,0,0,1,47.07,36.41Z"/><path d="M32,19.86A12.15894,12.15894,0,0,0,19.86,32c.66,16.11,23.62,16.11,24.28,0A12.15894,12.15894,0,0,0,32,19.86Zm0,22.85A10.71639,10.71639,0,0,1,21.29,32c.58-14.21,20.84-14.21,21.42,0A10.71639,10.71639,0,0,1,32,42.71Z"/><path d="M38.41,31.29h-4.4a2.14619,2.14619,0,0,0-1.3-1.3V23.43a.71009.71009,0,1,0-1.42,0v6.56a2.13487,2.13487,0,1,0,2.72,2.72h4.4A.71.71,0,0,0,38.41,31.29ZM32,32.71a.71.71,0,0,1,0-1.42A.71.71,0,0,1,32,32.71Z"/></svg>
)

const bracketSvg = (

<svg fill="none" height="50px" viewBox="0 0 29 30" width="50px" xmlns="http://www.w3.org/2000/svg"><g fill="rgb(0,0,0)"><path d="m18 21h-4c-.6 0-1-.4-1-1s.4-1 1-1h3v-14h-3c-.6 0-1-.4-1-1s.4-1 1-1h4c.6 0 1 .4 1 1v16c0 .6-.4 1-1 1z"/><path d="m5 17c-.6 0-1-.4-1-1s.4-1 1-1 1 .4 1 1-.4 1-1 1z"/><path d="m9 17c-.6 0-1-.4-1-1s.4-1 1-1 1 .4 1 1-.4 1-1 1z"/><path d="m13 17c-.6 0-1-.4-1-1s.4-1 1-1 1 .4 1 1-.4 1-1 1z"/></g></svg>
)
...
/* someskills realted projects cards */
  const card1 = {
    iconUrl: "https://cdn-icons-png.flaticon.com/512/8154/8154735.png",
    title: "Skills 360°",
    paragraph:
  ...
  /* card 3  */
  const card3 = {
    iconUrl: "https://cdn-icons-png.flaticon.com/512/5798/5798138.png",
    title: "Soft Skills",
    paragraph:
